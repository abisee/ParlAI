...
class TorchAgent(Agent):
    ...
    def add_cmdline_args(cls, argparser):
        ...
        agent.add_argument(
            ...
            choices = ['label', 'model'],
            help="When conditioning on dialog history, for previous replies either use the label i.e. dataset replies, or the model's own replies")
        agent.add_argument(
            '--add-p1-after-newln', type='bool', default=False,
            help="Put person1 token after last newline on first utterance")
        # GPU arguments
